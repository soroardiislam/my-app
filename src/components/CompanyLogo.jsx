...
const CompanyLogo = () => {
  ...
  return (
    <div className="w-full overflow-hidden gap-8 container mx-auto py-20 flex flex-col sm:flex-row sm:items-center items-start">
      <div className="w-75 shrink-0 px-5 text-gray-600 border-l-4 border-blue-500 bg-white py-2 z-10 sm:text-base text-xl font-semibold text-left">
